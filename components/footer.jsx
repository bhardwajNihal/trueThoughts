...
const Footer = () => {
  return (
    <footer className="w-full text-center flex flex-col gap-4 text-sm text-muted-foreground border-t-1 border-orange-600 backdrop-blur-xs bg-orange-100/50 rounded-t-4xl sm:rounded-t-full py-4 container mx-auto">
