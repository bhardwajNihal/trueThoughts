...
const Footer = () => {
  return (
    <footer className="mt-12 w-full text-center flex flex-col gap-4 text-sm text-muted-foreground border-t-2 border-orange-600 backdrop-blur-xs bg-orange-100/50 rounded-4xl sm:rounded-t-full py-6 container mx-auto">
