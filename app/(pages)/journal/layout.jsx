    ...
    return (
        <div className='min-h-screen w-full container mx-auto py-8 px-6 sm:px-12 md:px-20'>
            <div
                ...
                className='border w-fit flex items-center justify-center gap-2 border-orange-600 rounded-lg bg-orange-100/50 backdrop-blur-sm py-1 px-6 sm:px-10 cursor-pointer hover:bg-orange-100'>
