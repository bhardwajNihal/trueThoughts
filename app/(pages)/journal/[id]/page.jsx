    ...
    <div className="max-w-3xl mx-auto p-4">
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className="flex gap-3">
          ...
          <button className="flex items-center text-sm cursor-pointer hover:bg-red-500 hover:text-white gap-2 sm:px-4 p-1 border border-red-500 text-red-600 rounded">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4 text-sm text-zinc-500 mb-4">
        ...
        <div className='flex gap-2'>
          <span><span className='text-gray-600 font-semibold'>Created </span>{format(new Date(entryDetails.createdAt), "PPP")}</span>
          <span>
            <span className='text-gray-600 font-semibold'>Updated </span>
            {format(new Date(entryDetails.updatedAt), "PPP 'at' p")}
          </span>
        </div>
      </div>
